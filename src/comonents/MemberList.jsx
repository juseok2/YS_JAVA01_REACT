  ...
  <div class="input-container">
    <form id="userForm" onSubmit={addUser}>
      <table >
        ...
        <tr>
          <td>나이</td>
          <td><input type="text" placeholder="나이" id="ageInput" onChange={changeAge} value={age}/></td>
        </tr>
        <tr>
          <td>직업</td>
          <td><input  type="text" placeholder="직업" id="jobInput" onChange={changeJob} value={job}/></td>
        </tr>
      </table>
    </form>
  </div>
